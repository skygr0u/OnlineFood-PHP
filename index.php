...
<head>
    ...
    <link rel="icon" href="images/food-delivery.png">
    <title>Home</title>
						...
						if(empty($_SESSION["user_id"])) 
							{
                              ...
                              <li class="nav-item"><a href="admin/index.php" class="nav-link active" target="_blank">Admin</a> </li>';
							}
						else
							{
                                    ...
                                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                                            <div class="food-item-wrap">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="price-btn-block"> <span class="price">TND '.$r['price'].'</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                                                </div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>Rue Victor Hugo 2016, Carthage-Présidence</p>
                                    <h5>Phone: (216) 71775944</a></h5> </div>
